...
namespace Razor
{
	...
	Scene::Scene()
	{
		...
		//m_ViewportWidth = 1280;  // Default values
	...
	void Scene::OnComponentAdded<CameraComponent>(Entity entity, CameraComponent& component)
	{
		...
		{
			RZ_CORE_WARN("Viewport dimensions are 0x0. Skipping camera viewport setup.");
			return;
		}

		//RZ_CORE_INFO("Added TransformComponent to Entity {0}");
		RZ_CORE_INFO("Setting camera viewport to {0}x{1}", m_ViewportWidth, m_ViewportHeight);
